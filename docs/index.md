...
![MMI™ Flammarion LoXamarin Badge](assets/img/svg/MMI-Medmj-Org-Xamarint-Tree-Flammarion-Person-Through-Celestial-Sphere-circle-543-x-543.svg){:width="120px"}

- TOC
{:toc}

**Note**. The above **Live** rendition of the **MMI™ Flammarion LoXamarin Badge** ( if visible ) is an `( .svg )` image file set to the dimensions of 120.00 px X 120.00 px.
